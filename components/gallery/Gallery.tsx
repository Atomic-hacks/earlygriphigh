...
const Gallery: React.FC = () => {
  ...
  const categories: GalleryCategory[] = [
    ...
    { id: "campus", name: "Campus Life", count: 8 },
    { id: "academics", name: "Academics", count: 6 },
    { id: "sports", name: "Sports & Activities", count: 5 },
  ...
  const images: GalleryImage[] = [
    {
      id: "1",
      src: "https://images.unsplash.com/photo-1523050854058-8df90110c9d1?w=800&h=600&fit=crop",
      title: "Modern Learning Environment",
      category: "campus",
      description:
        "Students engaged in collaborative learning in our state-of-the-art classrooms",
      date: "2024",
    },
    {
      id: "2",
      ...
      category: "academics",
      description:
        "Advanced laboratory equipment for hands-on scientific exploration",
      date: "2024",
    },
    {
      id: "3",
      ...
      category: "campus",
      description:
        "Our spacious assembly hall where students gather for important events",
      date: "2024",
    },
    {
      id: "4",
      ...
      category: "academics",
      description:
        "Students learning various instruments in our music department",
      date: "2024",
    },
    {
      id: "5",
      ...
      category: "sports",
      description:
        "Modern sports facilities for physical education and athletics",
      date: "2024",
    },
    {
      id: "6",
    ...
    },
    {
      ...
      category: "campus",
      description: "Quiet study spaces equipped with modern learning resources",
      date: "2024",
    },
    {
      id: "8",
      ...
      category: "academics",
      description:
        "Technology-enhanced learning with modern computing facilities",
      date: "2024",
    },
    {
      id: "9",
      ...
      category: "events",
      description:
        "Students celebrating Nigerian heritage and cultural diversity",
      date: "2024",
    },
    {
      id: "10",
    ...
    },
    {
      ...
      category: "sports",
      description: "Indoor basketball facility for competitive sports",
      date: "2024",
    },
    {
      id: "12",
      src: "https://images.unsplash.com/photo-1594736797933-d0f06cafeec3?w=800&h=600&fit=crop",
